...
<div className="my-8 grid grid-cols-1 md:grid-cols-2 gap-4">
  <img src="/systems/montauk/1.png" alt="Montauk Console Interface" className="rounded-lg border border-border/40 w-full" />
  <img src="/systems/montauk/2.png" alt="Montauk Map Radar" className="rounded-lg border border-border/40 w-full" />
  <img src="/systems/montauk/3.png" alt="Montauk Settings" className="rounded-lg border border-border/40 w-full" />
  <img src="/systems/montauk/4.png" alt="Montauk Diagnostics" className="rounded-lg border border-border/40 w-full" />
</div>
