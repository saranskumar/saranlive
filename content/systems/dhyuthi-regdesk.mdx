...
stack: ["Next.js", "PWA", "Real-time API", "Tailwind CSS"]
...
image: "/systems/dhyuthi-ticket/dhyuthi-regdesk.png"
---

![Dhyuthi Ticketing System](/systems/dhyuthi-ticket/dhyuthi-regdesk.png)
...
<div className="my-8 grid grid-cols-2 md:grid-cols-4 gap-4">
  <img src="/systems/dhyuthi-ticket/ticket.png" alt="Digital Ticket View" className="rounded-lg border border-border/40 w-full" />
  <img src="/systems/dhyuthi-ticket/scanner.png" alt="QR Scanner Interface" className="rounded-lg border border-border/40 w-full" />
  <img src="/systems/dhyuthi-ticket/track.png" alt="Admission Tracking" className="rounded-lg border border-border/40 w-full" />
  <img src="/systems/dhyuthi-ticket/pending.png" alt="Pending Verifications" className="rounded-lg border border-border/40 w-full" />
</div>
